...
contract Manager is IManager {
    ...
    function createFund(uint256 fundId) public {
        ...
        require(funds[fundId].currentManager == address(0)); // require that the fund doesn't already exist
        require(!isActiveManager(msg.sender));
        funds[fundId].currentManager = msg.sender; // set the current manager
        _isActiveManager[msg.sender] = true; // set the flag
    }
